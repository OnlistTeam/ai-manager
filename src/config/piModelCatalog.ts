...
export const piModelCatalog = {
  ...
  "qwen/qwen3.8-max": {
    capabilities: {
      ...
      reasoning: true,
      input: ["text", "image"],
      // 983_616 rather than 1M: matches the value from QwenCloud's official Codex catalog and the OpenClaw config
  ...
  "qwen/qwen3.8-flash": {
    capabilities: {
      name: "Qwen3.8 Flash",
      reasoning: true,
      // The official Codex catalog does not list flash's input modality separately; treat it like the 3.8-max family
      input: ["text", "image"],
      contextWindow: 983_616,
      maxTokens: 131_072,
    },
