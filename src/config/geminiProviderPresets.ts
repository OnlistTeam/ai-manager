...
/**
 * Visual theme configuration for a Gemini preset provider
 */
export interface GeminiPresetTheme {
  /** Icon type: 'gemini' | 'generic' */
  icon?: "gemini" | "generic";
  /** Background color (selected state), supports hex colors */
  backgroundColor?: string;
  /** Text color (selected state), supports hex colors */
  textColor?: string;
}
