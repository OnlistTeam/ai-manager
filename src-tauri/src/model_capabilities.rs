...
pub(crate) fn is_confirmed_text_only_model(model: &str) -> bool {
    ...
    const CONFIRMED_TAILS: &[&str] = &[
        ...
        // `deepseek-v4-pro` is also intentionally absent: as of 2026-09-14 12:00
        // Beijing time, the vendor routes all deepseek-v4-pro requests to the
        // vision-capable V4.1 Flash (api-docs.deepseek.com/quick_start/pricing
        // note (2)); hard-blocking it as text-only would strip images, so it
        // must fail open.
        "glm-5.1",
...
mod tests {
    ...
    fn confirmed_text_only_registry_normalizes_namespaces_and_context_markers() {
        ...
        // v4-flash is a legacy alias that routes to the vision-capable
        // deepseek-flash; since 2026-09-14, v4-pro also routes to the
        // vision-capable V4.1 Flash. Both are removed from the list and must
        // fail open.
