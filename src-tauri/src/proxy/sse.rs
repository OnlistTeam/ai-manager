...
mod tests {
    ...
    fn multiple_split_characters_in_sequence() {
        let text = "€₹";
        let bytes = text.as_bytes(); // E2 82 AC E2 82 B9
    ...
    fn sse_json_with_multibyte_split_at_boundary() {
        // Simulates an SSE data line with multi-byte content split across chunks
        ...
        let split_point = ni_start + 1; // split inside "€"
