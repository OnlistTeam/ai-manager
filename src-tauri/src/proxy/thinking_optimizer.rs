...
/// Automatically optimizes the thinking configuration based on the model type
///
/// Three dispatch paths:
/// - skip: haiku models are skipped outright
/// - adaptive: current adaptive-thinking Claude models use adaptive thinking
/// - legacy: every other model gets enabled thinking + budget_tokens injected
...
/// Appends a beta flag to the anthropic_beta array (deduplicated)
