...
const COPY = {
  en: {
    ...
    "dl.source": "Downloads come from the project's own mirror. {link}.",
    "dl.sourceLink": "The same files are on GitHub Releases",
  ...
  zh: {
    ...
    "dl.checksum": "SHA-256",
    "dl.hashCopied": "已复制",
    "dl.source": "下载走的是本项目自己的镜像。{link}。",
    "dl.sourceLink": "GitHub Releases 上是同样的文件",
  ...
  "zh-TW": {
    ...
    "dl.checksum": "SHA-256",
    "dl.hashCopied": "已複製",
    "dl.source": "下載走的是本專案自己的鏡像。{link}。",
    "dl.sourceLink": "GitHub Releases 上是同樣的檔案",
  ...
  ja: {
    ...
    "dl.source":
      "ダウンロードはこのプロジェクト自身のミラーから配信しています。{link}。",
    "dl.sourceLink": "GitHub Releases にも同じファイルがあります",
